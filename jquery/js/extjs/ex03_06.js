$(function () {
    ...
    $("#inner_1 p :contains(내용2)").css({ "background-color": "red" });
    ...
    $("#inner_2 p").eq(2).css({ "color": "#ac5e04", "font-size": "34px", "text-decoration": "underline" });


    //end() => 바로 이전 선택 요소로 돌아가라는 기능을 제공해주는 함수. 현재 타겟의 요소를 종료한다는 의미
    $("#inner_1 p").eq(1).end().css({ "color": "#4455dd" });
});